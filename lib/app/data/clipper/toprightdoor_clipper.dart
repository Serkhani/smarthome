...
class TopRightDoorClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    topRightDoorPath.lineTo(
        modifiedSize.width * 0.725, modifiedSize.height * 0.190);
    topRightDoorPath.lineTo(
        modifiedSize.width * 0.705, modifiedSize.height * 0.190);
    topRightDoorPath.lineTo(
        modifiedSize.width * 0.705, modifiedSize.height * 0.2311);
